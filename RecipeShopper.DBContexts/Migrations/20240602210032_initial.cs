    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StockIngradientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockIngradients", x => x.StockIngradientId);
                });
            ...
            migrationBuilder.CreateTable(
                name: "CartIngradients",
                columns: table => new
                {
                    CartIngradientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StockIngradientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartIngradients", x => x.CartIngradientId);
                    table.ForeignKey(
                        name: "FK_CartIngradients_Recipes_RecipeId",
                        column: x => x.RecipeId,
